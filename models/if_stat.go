...
// IfStat represents a IfStat struct.
...
// MarshalJSON implements the json.Marshaler interface for IfStat.
// It customizes the JSON marshaling process for IfStat objects.
func (i IfStat) MarshalJSON() (
    []byte,
    error) {
    return json.Marshal(i.toMap())
}

// toMap converts the IfStat object to a map representation for JSON marshaling.
func (i IfStat) toMap() map[string]any {
