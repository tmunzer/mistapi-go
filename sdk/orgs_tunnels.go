...
// OrgsTunnels represents a controller struct.
type OrgsTunnels struct {
	baseController
}

// NewOrgsTunnels creates a new instance of OrgsTunnels.
// It takes a baseController as a parameter and returns a pointer to the OrgsTunnels.
func NewOrgsTunnels(baseController baseController) *OrgsTunnels {
	orgsTunnels := OrgsTunnels{baseController: baseController}
	return &orgsTunnels
}
...
func (o *OrgsTunnels) CountOrgTunnelsStats(
	ctx context.Context,
	orgId uuid.UUID,
	...
	req := o.prepareRequest(
		ctx,
		"GET",
		fmt.Sprintf("/api/v1/orgs/%v/stats/tunnels/count", orgId),
	)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (o *OrgsTunnels) SearchOrgTunnelsStats(
	ctx context.Context,
	orgId uuid.UUID,
	mxclusterId *string,
	siteId *string,
	...
	req := o.prepareRequest(
		ctx,
		"GET",
		fmt.Sprintf("/api/v1/orgs/%v/stats/tunnels/search", orgId),
	)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
