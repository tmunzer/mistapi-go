...
`func (o *ConfigDevice) GetOobIpConfig() GatewayOobIpConfig`

GetOobIpConfig returns the OobIpConfig field if non-nil, zero value otherwise.

### GetOobIpConfigOk

`func (o *ConfigDevice) GetOobIpConfigOk() (*GatewayOobIpConfig, bool)`
...
`func (o *ConfigDevice) SetOobIpConfig(v GatewayOobIpConfig)`
...
`func (o *ConfigDevice) GetOtherIpConfigs() map[string]JunosOtherIpConfig`

GetOtherIpConfigs returns the OtherIpConfigs field if non-nil, zero value otherwise.

### GetOtherIpConfigsOk

`func (o *ConfigDevice) GetOtherIpConfigsOk() (*map[string]JunosOtherIpConfig, bool)`
...
`func (o *ConfigDevice) SetOtherIpConfigs(v map[string]JunosOtherIpConfig)`
