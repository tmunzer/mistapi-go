...
func (s *SdkclientStatNetworkConnection) UnmarshalJSON(input []byte) error {
    var temp sdkclientStatNetworkConnection
...
// sdkclientStatNetworkConnection is a temporary struct used for validating the fields of SdkclientStatNetworkConnection.
type sdkclientStatNetworkConnection  struct {
    Mac         *string  `json:"mac"`
    Rssi        *float64 `json:"rssi"`
    SignalLevel *float64 `json:"signal_level"`
...
func (s *sdkclientStatNetworkConnection) validate() error {
    var errs []string
    if s.Mac == nil {
