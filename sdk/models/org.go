...
func (o *Org) UnmarshalJSON(input []byte) error {
    ...
    additionalProperties, err := UnmarshalAdditionalProperties(input, "alarmtemplate_id", "allow_mist", "created_time", "id", "modified_time", "msp_id", "msp_logo_url", "msp_name", "name", "orggroup_ids", "session_expiry")
    if err != nil {
    	return err
    }
