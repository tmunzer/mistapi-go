...
func (c *ConstNacEvent) UnmarshalJSON(input []byte) error {
    ...
    additionalProperties, err := UnmarshalAdditionalProperties(input, "ap", "bssid", "cert_cn", "cert_expiry", "cert_issuer", "cert_san_upn", "cert_serial", "cert_subject", "eap_type", "nas_vendor", "org_id", "random_mac", "site_id", "ssid", "timestamp", "type", "username", "wcid")
    if err != nil {
    	return err
    }
