...
// orgSiteWiredWifi is a temporary struct used for validating the fields of OrgSiteWiredWifi.
type orgSiteWiredWifi  struct {
    End      *float64                 `json:"end"`
    Interval *int                     `json:"interval"`
    Limit    *int                     `json:"limit"`
...
func (o *orgSiteWiredWifi) validate() error {
    var errs []string
    if o.End == nil {
