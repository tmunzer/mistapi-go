...
type GatewayOobIpConfig struct {
    ...
    Type                 *IpConfigTypeEnum        `json:"type,omitempty"`
...
func (g *GatewayOobIpConfig) UnmarshalJSON(input []byte) error {
    ...
    additionalProperties, err := UnmarshalAdditionalProperties(input, "ip", "netmask", "network", "node1", "type", "use_mgmt_vrf", "use_mgmt_vrf_for_host_out")
    if err != nil {
    	return err
    }
