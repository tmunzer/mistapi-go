...
// ApStatsStatusEnum is a string enum.
type ApStatsStatusEnum string

const (
    ApStatsStatusEnum_CONNECTED    ApStatsStatusEnum = "connected"
    ApStatsStatusEnum_DISCONNECTED ApStatsStatusEnum = "disconnected"
    ApStatsStatusEnum_RESTARTING   ApStatsStatusEnum = "restarting"
    ApStatsStatusEnum_UPGRADING    ApStatsStatusEnum = "upgrading"
)
...
// IpConfigTypeEnum is a string enum.
type IpConfigTypeEnum string

const (
    IpConfigTypeEnum_STATIC  IpConfigTypeEnum = "static"
    IpConfigTypeEnum_DYNAMIC IpConfigTypeEnum = "dynamic"
)
