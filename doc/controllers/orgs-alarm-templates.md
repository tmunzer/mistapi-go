...
|  --- | --- | --- | --- |
| `orgId` | `uuid.UUID` | Template, Required | - |
| `scope` | [`*models.SuppressedAlarmScopeEnum`](../../doc/models/suppressed-alarm-scope-enum.md) | Query, Optional | Filter results by scope. enum: `org`, `site`<br><br>**Default**: `"site"` |
