...
```go
orgsTunnels := client.OrgsTunnels()
```
...
* [Count Org Tunnels Stats](../../doc/controllers/orgs-tunnels.md#count-org-tunnels-stats)
* [Search Org Tunnels Stats](../../doc/controllers/orgs-tunnels.md#search-org-tunnels-stats)
...
apiResponse, err := orgsTunnels.CountOrgTunnelsStats(ctx, orgId, &distinct, &mType)
if err != nil {
    log.Fatalln(err)
} else {
...
apiResponse, err := orgsTunnels.SearchOrgTunnelsStats(ctx, orgId, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &mType, &limit, nil, nil, &duration)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
