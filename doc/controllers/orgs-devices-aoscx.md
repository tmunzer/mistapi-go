...
**200**: AOSCX Brownfield Registration Commands

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [models.AoscxRegisterCmd](../../doc/models/aoscx-register-cmd.md).
