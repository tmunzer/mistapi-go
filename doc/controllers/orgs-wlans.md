...
body := models.WlanPortalTemplate{
    PortalTemplate:       models.ToPointer(models.WlanPortalTemplateSetting{
        AccessCodeAlternateEmail:  models.ToPointer("string"),
        Alignment:                 models.ToPointer(models.PortalTemplateAlignmentEnum_LEFT),
        AuthButtonAmazon:          models.ToPointer("string"),
        AuthButtonAzure:           models.ToPointer("string"),
        AuthButtonEmail:           models.ToPointer("string"),
        AuthButtonFacebook:        models.ToPointer("string"),
        AuthButtonGoogle:          models.ToPointer("string"),
        AuthButtonMicrosoft:       models.ToPointer("string"),
        AuthButtonPassphrase:      models.ToPointer("string"),
        AuthButtonSms:             models.ToPointer("string"),
        AuthButtonSponsor:         models.ToPointer("string"),
        AuthLabel:                 models.ToPointer("string"),
        BackLink:                  models.ToPointer("string"),
        Color:                     models.ToPointer("string"),
        ColorDark:                 models.ToPointer("string"),
        ColorLight:                models.ToPointer("string"),
        Company:                   models.ToPointer(true),
        CompanyError:              models.ToPointer("string"),
        CompanyLabel:              models.ToPointer("string"),
        Email:                     models.ToPointer(true),
        EmailAccessDomainError:    models.ToPointer("string"),
        EmailCancel:               models.ToPointer("string"),
        EmailCodeError:            models.ToPointer("string"),
        EmailError:                models.ToPointer("string"),
        EmailFieldLabel:           models.ToPointer("string"),
        EmailLabel:                models.ToPointer("string"),
        EmailMessage:              models.ToPointer("string"),
        EmailSubmit:               models.ToPointer("string"),
        EmailTitle:                models.ToPointer("string"),
        Field1:                    models.ToPointer(true),
        Field1Error:               models.ToPointer("string"),
        Field1Label:               models.ToPointer("string"),
        Field1Required:            models.ToPointer(true),
        Field2:                    models.ToPointer(true),
        Field2Error:               models.ToPointer("string"),
        Field2Label:               models.ToPointer("string"),
        Field2Required:            models.ToPointer(true),
        Field3:                    models.ToPointer(true),
        Field3Error:               models.ToPointer("string"),
        Field3Label:               models.ToPointer("string"),
        Field3Required:            models.ToPointer(true),
        Field4:                    models.ToPointer(true),
        Field4Error:               models.ToPointer("string"),
        Field4Label:               models.ToPointer("string"),
        Field4Required:            models.ToPointer(true),
        Message:                   models.ToPointer("string"),
        Name:                      models.ToPointer(true),
        NameError:                 models.ToPointer("string"),
        NameLabel:                 models.ToPointer("string"),
        Optout:                    models.ToPointer(true),
        OptoutLabel:               models.ToPointer("string"),
        PageTitle:                 "string",
        PassphraseCancel:          models.ToPointer("string"),
        PassphraseError:           models.ToPointer("string"),
        PassphraseLabel:           models.ToPointer("string"),
        PassphraseMessage:         models.ToPointer("string"),
        PassphraseSubmit:          models.ToPointer("string"),
        PassphraseTitle:           models.ToPointer("string"),
        PoweredBy:                 models.ToPointer(true),
        RequiredFieldLabel:        models.ToPointer("string"),
        SignInLabel:               models.ToPointer("string"),
        SmsCarrierDefault:         models.ToPointer("string"),
        SmsCarrierError:           models.ToPointer("string"),
        SmsCarrierFieldLabel:      models.ToPointer("string"),
        SmsCodeCancel:             models.ToPointer("string"),
        SmsCodeError:              models.ToPointer("string"),
        SmsCodeFieldLabel:         models.ToPointer("string"),
        SmsCodeMessage:            models.ToPointer("string"),
        SmsCodeSubmit:             models.ToPointer("string"),
        SmsCodeTitle:              models.ToPointer("string"),
        SmsCountryFieldLabel:      models.ToPointer("string"),
        SmsCountryFormat:          models.ToPointer("string"),
        SmsHaveAccessCode:         models.ToPointer("string"),
        SmsMessageFormat:          models.ToPointer("string"),
        SmsNumberCancel:           models.ToPointer("string"),
        SmsNumberError:            models.ToPointer("string"),
        SmsNumberFieldLabel:       models.ToPointer("string"),
        SmsNumberFormat:           models.ToPointer("string"),
        SmsNumberMessage:          models.ToPointer("string"),
        SmsNumberSubmit:           models.ToPointer("string"),
        SmsNumberTitle:            models.ToPointer("string"),
        SmsUsernameFormat:         models.ToPointer("string"),
        SmsValidityDuration:       models.ToPointer(30),
        SponsorBackLink:           models.ToPointer("string"),
        SponsorCancel:             models.ToPointer("string"),
        SponsorEmail:              models.ToPointer("string"),
        SponsorEmailError:         models.ToPointer("string"),
        SponsorEmailTemplate:      models.ToPointer("string"),
        SponsorInfoApproved:       models.ToPointer("string"),
        SponsorInfoDenied:         models.ToPointer("string"),
        SponsorInfoPending:        models.ToPointer("string"),
        SponsorName:               models.ToPointer("string"),
        SponsorNameError:          models.ToPointer("string"),
        SponsorNotePending:        models.ToPointer("string"),
        SponsorStatusApproved:     models.ToPointer("string"),
        SponsorStatusDenied:       models.ToPointer("string"),
        SponsorStatusPending:      models.ToPointer("string"),
        SponsorSubmit:             models.ToPointer("string"),
        SponsorsFieldLabel:        models.ToPointer("string"),
        Tos:                       models.ToPointer(true),
        TosAcceptLabel:            models.ToPointer("string"),
        TosError:                  models.ToPointer("string"),
        TosLink:                   models.ToPointer("string"),
        TosText:                   models.ToPointer("string"),
    }),
}

apiResponse, err := orgsWlans.UpdateOrgWlanPortalTemplate(ctx, orgId, wlanId, &body)
if err != nil {
    switch typedErr := err.(type) {
        case *errors.ResponseHttp400:
            log.Fatalln("ResponseHttp400Exception: ", typedErr)
