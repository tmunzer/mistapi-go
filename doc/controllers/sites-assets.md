...
|  --- | --- | --- | --- |
| `siteId` | `uuid.UUID` | Template, Required | - |
| `upsert` | [`*models.ImportSiteAssetsUpsertEnum`](../../doc/models/import-site-assets-upsert-enum.md) | Query, Optional | Whether to replace existing assets with the same MAC address during import. enum: `False`, `True`<br><br>**Default**: `"False"` |
| `file` | `*models.FileWrapper` | Form, Optional | CSV file containing asset records to import |
...
List assets for a site. Use [List Org Assets](../../doc/controllers/orgs-assets.md#list-org-assets) to retrieve assets across the organization.
