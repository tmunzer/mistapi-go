...
* [Count Org Vars](../../doc/controllers/orgs-vars.md#count-org-vars)
* [Search Org Vars](../../doc/controllers/orgs-vars.md#search-org-vars)
...
| `distinct` | [`*models.OrgVarsCountDistinctEnum`](../../doc/models/org-vars-count-distinct-enum.md) | Query, Optional | Field used to group this count response. enum: `site_id`, `src`, `var`<br><br>**Default**: `"var"` |
...
distinct := models.OrgVarsCountDistinctEnum_ENUMVAR
