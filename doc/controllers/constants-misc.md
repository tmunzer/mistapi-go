...
* [List Applications](../../doc/controllers/constants-misc.md#list-applications)
* [List Country Codes](../../doc/controllers/constants-misc.md#list-country-codes)
* [List Gateway Applications](../../doc/controllers/constants-misc.md#list-gateway-applications)
...
* [List Traffic Types](../../doc/controllers/constants-misc.md#list-traffic-types)
...
apiResponse, err := constantsMisc.ListApplications(ctx)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
...
apiResponse, err := constantsMisc.ListCountryCodes(ctx)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
...
apiResponse, err := constantsMisc.ListGatewayApplications(ctx)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
...
apiResponse, err := constantsMisc.ListTrafficTypes(ctx)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
