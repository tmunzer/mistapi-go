    ...
    Wlans:        []models.Wlan{
        models.Wlan{
            ...
            Portal:                             models.ToPointer(models.WlanPortal{
                ...
                PortalApiSecret:             models.ToPointer("string"),
                PortalImage:                 models.ToPointer("https://url/to/image.png"),
                PortalSsoUrl:                models.ToPointer("string"),
                ...
                SsoIdpSignAlgo:              models.ToPointer("string"),
            ...
            PortalImage:                        models.NewOptional(models.ToPointer("http://example.com")),
            PortalSsoUrl:                       models.NewOptional(models.ToPointer("string")),
            PortalTemplateUrl:                  models.NewOptional(models.ToPointer("string")),
            ...
            Rateset:                            map[string]models.WlanDatarates{
                "24": models.WlanDatarates{
                    ...
                    Template: models.NewOptional(models.ToPointer("string")),
                    Vht:      models.ToPointer("03ff03ff03ff01ff"),
                },
            ...
            VlanId:                             models.NewOptional(models.ToPointer(1)),
            VlanIds:                            []int{
                3,
                4,
                5,
