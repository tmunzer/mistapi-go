...
* [Create Org Security Zone](../../doc/controllers/orgs-security-zones.md#create-org-security-zone)
* [Delete Org Security Zone](../../doc/controllers/orgs-security-zones.md#delete-org-security-zone)
* [Get Org Security Zone](../../doc/controllers/orgs-security-zones.md#get-org-security-zone)
* [List Org Security Zones](../../doc/controllers/orgs-security-zones.md#list-org-security-zones)
* [Update Org Security Zone](../../doc/controllers/orgs-security-zones.md#update-org-security-zone)


# Create Org Security Zone
...
| `body` | [`*models.Securityzone`](../../doc/models/securityzone.md) | Body, Optional | Request Body |

## Response Type

**200**: OK

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [models.Securityzone](../../doc/models/securityzone.md).
...
```json
{
  "created_time": 1656353525,
  "id": "a045ea40-ccd0-4660-8f35-0305fae26e9c",
...
|  --- | --- | --- | --- |
| `orgId` | `uuid.UUID` | Template, Required | - |
| `securityzoneId` | `uuid.UUID` | Template, Required | - |
...
securityzoneId := uuid.MustParse("000000ab-00ab-00ab-00ab-0000000000ab")
