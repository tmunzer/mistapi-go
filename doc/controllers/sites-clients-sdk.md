...
```go
sitesClientsSDK := client.SitesClientsSDK()
```
...
* [Get Site Sdk Stats](../../doc/controllers/sites-clients-sdk.md#get-site-sdk-stats)
* [Get Site Sdk Stats by Map](../../doc/controllers/sites-clients-sdk.md#get-site-sdk-stats-by-map)
...
apiResponse, err := sitesClientsSDK.GetSiteSdkStats(ctx, siteId, sdkclientId)
if err != nil {
    log.Fatalln(err)
} else {
...
apiResponse, err := sitesClientsSDK.GetSiteSdkStatsByMap(ctx, siteId, mapId)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
