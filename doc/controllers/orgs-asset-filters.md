...
body := models.AssetFilter{
    ...
    IbeaconUuid:           models.NewOptional(models.ToPointer(uuid.MustParse("1f89bc00-d0af-481b-82fe-a6629259a39f"))),
...
body := models.AssetFilter{
    ...
    EddystoneUrl:          models.ToPointer("string"),
    IbeaconMajor:          models.NewOptional(models.ToPointer(1)),
    IbeaconUuid:           models.NewOptional(models.ToPointer(uuid.MustParse("b069b358-4c97-5319-1f8c-7c5ca64d6ab2"))),
    MfgCompanyId:          models.ToPointer(0),
    Name:                  "string",
}
