...
| `distinct` | [`*models.SiteRogueEventsCountDistinctEnum`](../../doc/models/site-rogue-events-count-distinct-enum.md) | Query, Optional | - |
...
|  --- | --- | --- | --- |
| `siteId` | `uuid.UUID` | Template, Required | - |
| `rogueBssid` | `string` | Template, Required | - |
