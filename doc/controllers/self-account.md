...
if err != nil {
    switch typedErr := err.(type) {
        case *errors.ErrorDeleteFailed:
            log.Fatalln("ErrorDeleteFailedException: ", typedErr)
...
**200**: With correct verification, the email address of the user will be updated
