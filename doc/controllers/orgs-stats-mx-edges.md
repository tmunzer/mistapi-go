...
| `forSite` | `*bool` | Query, Optional | Filter results by whether the object is scoped to a site<br><br>**Default**: `false` |
...
|  --- | --- | --- | --- |
| `orgId` | `uuid.UUID` | Template, Required | - |
| `forSite` | [`*models.ForSiteEnum`](../../doc/models/for-site-enum.md) | Query, Optional | Filter for site level Mist Edges. enum: `any`, `true`, `false` |
