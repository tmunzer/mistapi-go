...
To assign a gateway template to a site, use the [Update Site](../../doc/controllers/sites.md#update-site-info) endpoint and specify the gateway template ID in the `gatewaytemplate_id` field of the request body.
