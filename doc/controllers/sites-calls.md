...
* [List Site Troubleshoot Calls](../../doc/controllers/sites-calls.md#list-site-troubleshoot-calls)
* [Search Site Calls](../../doc/controllers/sites-calls.md#search-site-calls)
* [Troubleshoot Site Call](../../doc/controllers/sites-calls.md#troubleshoot-site-call)
...
| `distrinct` | [`*models.CountSiteCallsDistrinctEnum`](../../doc/models/count-site-calls-distrinct-enum.md) | Query, Optional | - |
| `rating` | `*int` | Query, Optional | feedback rating (e.g. "rating=1" or "rating=1,2") |
...
apiResponse, err := sitesCalls.CountSiteCalls(ctx, siteId, &distrinct, nil, nil, nil, nil)
if err != nil {
    log.Fatalln(err)
} else {
...
apiResponse, err := sitesCalls.ListSiteTroubleshootCalls(ctx, siteId, clientMac, nil, nil, nil, &app, nil, nil, &duration, &limit, &page)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
...
apiResponse, err := sitesCalls.SearchSiteCalls(ctx, siteId, nil, &app, &limit, nil, nil, &duration)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
...
apiResponse, err := sitesCalls.TroubleshootSiteCall(ctx, siteId, clientMac, meetingId, nil, &app, nil, nil, &duration, &limit, &page)
if err != nil {
    log.Fatalln(err)
} else {
    // Printing the result and response
