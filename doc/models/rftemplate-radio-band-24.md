...
|  --- | --- | --- | --- |
| `AllowRrmDisable` | `*bool` | Optional | Whether RRM may disable the 2.4 GHz radio when optimizing RF settings<br><br>**Default**: `false` |
| `AntGain` | `models.Optional[int]` | Optional | External antenna gain for the 2.4 GHz radio<br><br>**Default**: `0`<br><br>**Constraints**: `>= 0`, `<= 10` |
...
| `PowerMax` | `models.Optional[int]` | Optional | When power=null/unset, max tx power to use, HW-specific values will be used if not set<br><br>**Constraints**: `>= 3`, `<= 18` |
| `PowerMin` | `models.Optional[int]` | Optional | When power=null/unset, min tx power to use, HW-specific values will be used if not set<br><br>**Constraints**: `>= 3`, `<= 18` |
...
func main() {
    rftemplateRadioBand24 := models.RftemplateRadioBand24{
        ...
        Power:                models.NewOptional(models.ToPointer(3)),
