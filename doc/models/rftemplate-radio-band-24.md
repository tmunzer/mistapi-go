...
| `Power` | `models.Optional[int]` | Optional | tx power of the radio, null or 0 means auto, when power_min=power_max=power=0 to indicate power=0<br>**Constraints**: `>= 3`, `<= 25` |
