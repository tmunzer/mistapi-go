...
func main() {
    apRadioBand5 := models.ApRadioBand5{
        AllowRrmDisable:      models.ToPointer(false),
        AntGain:              models.NewOptional(models.ToPointer(0)),
        AntennaBeamPattern:   models.ToPointer(models.RadioBandAntennaBeamPatternEnum_WIDE),
        ...
        Channel:              models.NewOptional(models.ToPointer(100)),
