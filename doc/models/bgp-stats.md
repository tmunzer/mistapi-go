...
| `FlapCount` | `*int` | Optional | Number of times the BGP session has flapped |
...
| `RouterId` | `*string` | Optional | Local router ID (IP address) of the device reporting this BGP peer |
...
func main() {
    bgpStats := models.BgpStats{
        ...
        RouterId:             models.ToPointer("172.16.254.2"),
