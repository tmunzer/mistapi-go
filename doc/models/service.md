...
| `Description` | `*string` | Optional | Free-form description of the service definition |
...
| `Name` | `*string` | Optional | Display name of the service definition |
...
| `SsrRelaxedTcpStateEnforcement` | `*bool` | Optional | Whether SSR relaxes TCP state enforcement for this service<br><br>**Default**: `false` |
...
func main() {
    service := models.Service{
        ...
        ClientLimitDown:               models.ToPointer(300000),
        ClientLimitUp:                 models.ToPointer(300000),
        FailoverPolicy:                models.ToPointer(models.ServiceFailoverPolicyEnum_REVERTIBLE),
        Id:                            models.ToPointer(uuid.MustParse("53f10664-3ce8-4c27-b382-0ef66432349f")),
        OrgId:                         models.ToPointer(uuid.MustParse("a97c1b22-a4e9-411e-9bfd-d8695a0f9e61")),
        ServiceLimitDown:              models.ToPointer(300000),
        ServiceLimitUp:                models.ToPointer(300000),
        SleEnabled:                    models.ToPointer(false),
        SsrRelaxedTcpStateEnforcement: models.ToPointer(false),
