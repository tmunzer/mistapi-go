...
| `Force` | `*bool` | Optional | `force`==`true` will force upgrade when requested version is same as running version<br>**Default**: `false` |
...
| `P2pClusterSize` | `*int` | Optional | If `enable_p2p`==`true`.<br>**Default**: `10`<br>**Constraints**: `>= 0` |
| `P2pParallelism` | `*int` | Optional | If `enable_p2p`==`true`. Number of parallel p2p download batches to create |
