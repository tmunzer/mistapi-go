...
| `RadiusGroup` | `*string` | Optional | Required if:<br><br>* `type`==`radius_group`<br>* `type`==`aruba_user_role`<br>* `type`==`static_gbp`<br>  if from matching radius_group |
| `Specs` | [`[]models.AclTagSpec`](../../doc/models/acl-tag-spec.md) | Optional | If `type`==`resource`, `type`==`radius_group`, `type`==`aruba_user_role`, `type`==`port_usage` or `type`==`gbp_resource`. Empty means unrestricted, i.e. any |
...
func main() {
    aclTag := models.AclTag{
        ...
        Type:                 models.AclTagTypeEnum_STATICGBP,
    }
