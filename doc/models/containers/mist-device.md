...
```go
value := models.MistDeviceContainer.FromDeviceAp(models.DeviceAp{
...
```go
value := models.MistDeviceContainer.FromDeviceSwitch(models.DeviceSwitch{
...
```go
value := models.MistDeviceContainer.FromDeviceGateway(models.DeviceGateway{
