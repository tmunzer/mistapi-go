...
| `Src` | [`*models.StatsApGpsStatSrcEnum`](../../doc/models/stats-ap-gps-stat-src-enum.md) | Optional | The origin of the GPS data. enum: `gps`: from this device GPS estimates, `other_aps` from neighboring devices GPS estimates. Note: API responses may return `other_aps` which should be treated as `other_ap` |
