...
|  --- | --- | --- | --- |
| `Band` | `*string` | Optional | Radio band used by this mesh uplink |
| `Channel` | `*int` | Optional | Radio channel used by this mesh uplink |
| `IdleTime` | `*int` | Optional | Seconds since traffic was last observed on this mesh uplink |
| `LastSeen` | `models.Optional[float64]` | Optional, Read-only | Timestamp indicating when the entity was last seen |
| `Proto` | `*string` | Optional | 802.11 protocol reported for this mesh uplink |
| `Rssi` | `*int` | Optional | Received signal strength for this mesh uplink, in dBm |
...
| `Snr` | `*int` | Optional | Signal-to-noise ratio for this mesh uplink, in dB |
...
| `UplinkApId` | `*uuid.UUID` | Optional | Identifier of the upstream AP for this mesh uplink |
...
func main() {
    apStatMeshUplink := models.ApStatMeshUplink{
        ...
        UplinkApId:           models.ToPointer(uuid.MustParse("00000000-0000-0000-1000-5c5b35000010")),
    }
