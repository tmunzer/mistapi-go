...
| `Fingerprinting` | [`*models.OrgSettingMistNacFingerprinting`](../../doc/models/org-setting-mist-nac-fingerprinting.md) | Optional | Allows customer to enable client fingerprinting for policy enforcement |
