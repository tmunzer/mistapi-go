...
This event's request payload is of type [*models.WebhookLocationSdk](../../../../doc/models/webhook-location-sdk.md).
...
func WebhooksGinEventHandler(c *gin.Context) {
    ...
    if event, ok := parsingResult.AsLocationSdk(); ok {
        c.JSON(200, map[string]any{
            "status":    "success",
            "eventInfo": fmt.Sprintf("LocationSdk event received %v", event),
        })
