...
This event's request payload is of type [*models.WebhookClientSessions](../../../../doc/models/webhook-client-sessions.md).
...
func WebhooksGinEventHandler(c *gin.Context) {
    ...
    if event, ok := parsingResult.AsClientSessions(); ok {
        c.JSON(200, map[string]any{
            "status":    "success",
            "eventInfo": fmt.Sprintf("ClientSessions event received %v", event),
        })
