...
This event's request payload is of type [*models.WebhookDeviceEvents](../../../../doc/models/webhook-device-events.md).
...
func WebhooksGinEventHandler(c *gin.Context) {
    ...
    if event, ok := parsingResult.AsDeviceEvents(); ok {
        c.JSON(200, map[string]any{
            "status":    "success",
            "eventInfo": fmt.Sprintf("DeviceEvents event received %v", event),
        })
