...
This event's request payload is of type [*models.WebhookLocationClient](../../../../doc/models/webhook-location-client.md).
...
func WebhooksGinEventHandler(c *gin.Context) {
    ...
    if event, ok := parsingResult.AsLocationClient(); ok {
        c.JSON(200, map[string]any{
            "status":    "success",
            "eventInfo": fmt.Sprintf("LocationClient event received %v", event),
        })
