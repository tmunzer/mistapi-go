...
This event's request payload is of type [*models.WebhookLocationUnclient](../../../../doc/models/webhook-location-unclient.md).
...
func WebhooksGinEventHandler(c *gin.Context) {
    ...
    if event, ok := parsingResult.AsLocationUnclient(); ok {
        c.JSON(200, map[string]any{
            "status":    "success",
            "eventInfo": fmt.Sprintf("LocationUnclient event received %v", event),
        })
