...
This event's request payload is of type [*models.WebhookOccupancyAlerts](../../../../doc/models/webhook-occupancy-alerts.md).
...
func WebhooksGinEventHandler(c *gin.Context) {
    ...
    if event, ok := parsingResult.AsOccupancyAlerts(); ok {
        c.JSON(200, map[string]any{
            "status":    "success",
            "eventInfo": fmt.Sprintf("OccupancyAlerts event received %v", event),
        })
