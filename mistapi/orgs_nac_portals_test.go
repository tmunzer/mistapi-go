...
func TestOrgsNACPortalsTestCreateOrgNacPortal(t *testing.T) {
	...
	testHelper.CheckResponseHeaders(t, apiResponse.Response.Header, expectedHeaders, true)
	expected := `{"access_type":"wireless","cert_expire_time":365,"enable_location":false,"enable_telemetry":true,"expiry_notification_time":2,"name":"get-wifi","notify_expiry":true,"ssid":"Corp","sso":{"idp_cert":"-----BEGIN CERTIFICATE-----\nMIIFZjCCA06gAwIBAgIIP61/1qm/uDowDQYJKoZIhvcNAQELBQE\n-----END CERTIFICATE-----","idp_sign_algo":"sha256","idp_sso_url":"https://yourorg.onelogin.com/trust/saml2/http-post/sso/138130","issuer":"https://app.onelogin.com/saml/metadata/138130","nameid_format":"email","sso_role_matching":[{"assigned":"user","match":"Student"}],"use_sso_role_for_cert":true}}`
	testHelper.KeysBodyMatcher(t, expected, apiResponse.Response.Body, false, false)
}

// TestOrgsNACPortalsTestCreateOrgNacPortal1 tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestCreateOrgNacPortal1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestGetOrgNacPortal1 tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestGetOrgNacPortal1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestUpdateOrgNacPortal1 tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestUpdateOrgNacPortal1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestListOrgNacPortalSsoLatestFailures1 tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestListOrgNacPortalSsoLatestFailures1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestGetOrgNacPortalSamlMetadata tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestGetOrgNacPortalSamlMetadata(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestGetOrgNacPortalSamlMetadata1 tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestGetOrgNacPortalSamlMetadata1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestDownloadOrgNacPortalSamlMetadata tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestDownloadOrgNacPortalSamlMetadata(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNACPortalsTestDownloadOrgNacPortalSamlMetadata1 tests the behavior of the OrgsNACPortals
func TestOrgsNACPortalsTestDownloadOrgNacPortalSamlMetadata1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
