...
// TestSitesBeaconsTestListSiteBeacons1 tests the behavior of the SitesBeacons
func TestSitesBeaconsTestListSiteBeacons1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesBeaconsTestCreateSiteBeacon1 tests the behavior of the SitesBeacons
func TestSitesBeaconsTestCreateSiteBeacon1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesBeaconsTestGetSiteBeacon1 tests the behavior of the SitesBeacons
func TestSitesBeaconsTestGetSiteBeacon1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesBeaconsTestUpdateSiteBeacon1 tests the behavior of the SitesBeacons
func TestSitesBeaconsTestUpdateSiteBeacon1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
