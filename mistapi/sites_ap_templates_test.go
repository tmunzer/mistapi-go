...
// TestSitesAPTemplatesTestListSiteApTemplateDerived tests the behavior of the SitesAPTemplates
func TestSitesAPTemplatesTestListSiteApTemplateDerived(t *testing.T) {
