...
// TestSitesAPTemplatesTestGetSiteApTemplateDerived tests the behavior of the SitesAPTemplates
func TestSitesAPTemplatesTestGetSiteApTemplateDerived(t *testing.T) {
    ...
    apiResponse, err := sitesApTemplates.GetSiteApTemplateDerived(ctx, siteId, nil)
    if err != nil {
