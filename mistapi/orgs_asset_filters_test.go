...
func TestOrgsAssetFiltersTestCreateOrgAssetFilter(t *testing.T) {
	...
	errBody := json.Unmarshal([]byte(`{"disabled":true,"eddystone_uid_namespace":"string","eddystone_url":"string","ibeacon_major":1,"ibeacon_uuid":"1f89bc00-d0af-481b-82fe-a6629259a39f","mfg_company_id":0,"name":"string"}`), &body)
	if errBody != nil {
	...
	testHelper.CheckResponseHeaders(t, apiResponse.Response.Header, expectedHeaders, true)
	expected := `{"created_time":0,"disabled":true,"eddystone_uid_namespace":"string","eddystone_url":"string","for_site":true,"ibeacon_major":1,"ibeacon_uuid":"b069b358-4c97-5319-1f8c-7c5ca64d6ab1","id":"b069b358-4c97-5319-1f8c-7c5ca64d6ab1","mfg_company_id":0,"modified_time":0,"mqtt_topic":"xxxxx","name":"string","org_id":"b069b358-4c97-5319-1f8c-7c5ca64d6ab1","site_id":"b069b358-4c97-5319-1f8c-7c5ca64d6ab1"}`
...
func TestOrgsAssetFiltersTestUpdateOrgAssetFilter(t *testing.T) {
	...
	var body models.AssetFilter
	errBody := json.Unmarshal([]byte(`{"disabled":true,"eddystone_uid_namespace":"string","eddystone_url":"string","ibeacon_major":1,"ibeacon_uuid":"b069b358-4c97-5319-1f8c-7c5ca64d6ab2","mfg_company_id":0,"name":"string"}`), &body)
	if errBody != nil {
		t.Errorf("Cannot parse the model object.")
	}
