...
// TestOrgsNACRulesTestListOrgNacRules1 tests the behavior of the OrgsNACRules
func TestOrgsNACRulesTestListOrgNacRules1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsNACRulesTestCreateOrgNacRule1 tests the behavior of the OrgsNACRules
func TestOrgsNACRulesTestCreateOrgNacRule1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsNACRulesTestGetOrgNacRule1 tests the behavior of the OrgsNACRules
func TestOrgsNACRulesTestGetOrgNacRule1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsNACRulesTestUpdateOrgNacRule1 tests the behavior of the OrgsNACRules
func TestOrgsNACRulesTestUpdateOrgNacRule1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
