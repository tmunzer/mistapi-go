...
// TestSitesSiteTemplatesTestListSiteSiteTemplateDerived tests the behavior of the SitesSiteTemplates
func TestSitesSiteTemplatesTestListSiteSiteTemplateDerived(t *testing.T) {
