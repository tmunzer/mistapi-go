...
func (o *OrgsSecIntelProfiles) CreateOrgSecIntelProfile(
	...
	models.ApiResponse[models.SecintelProfile],
	error) {
	req := o.prepareRequest(ctx, "POST", "/api/v1/orgs/%v/secintelprofiles")
	req.AppendTemplateParams(orgId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (o *OrgsSecIntelProfiles) DeleteOrgSecIntelProfile(
	...
	*http.Response,
	error) {
	req := o.prepareRequest(ctx, "DELETE", "/api/v1/orgs/%v/secintelprofiles/%v")
	req.AppendTemplateParams(orgId, secintelprofileId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
			NewAuth("basicAuth"),
...
func (o *OrgsSecIntelProfiles) GetOrgSecIntelProfile(
	...
	models.ApiResponse[models.SecintelProfile],
	error) {
	req := o.prepareRequest(ctx, "GET", "/api/v1/orgs/%v/secintelprofiles/%v")
	req.AppendTemplateParams(orgId, secintelprofileId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (o *OrgsSecIntelProfiles) UpdateOrgSecIntelProfile(
	...
	models.ApiResponse[models.SecintelProfile],
	error) {
	req := o.prepareRequest(ctx, "PUT", "/api/v1/orgs/%v/secintelprofiles/%v")
	req.AppendTemplateParams(orgId, secintelprofileId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
