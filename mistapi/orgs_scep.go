...
func (o *OrgsSCEP) DisableOrgMistScep(
    ...
    req := o.prepareRequest(
      ctx,
      "DELETE",
      fmt.Sprintf("/api/v1/orgs/%v/setting/mist_scep", orgId),
    )
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
...
func (o *OrgsSCEP) GetOrgIssuedClientCertificates(
    ...
    req := o.prepareRequest(
      ctx,
      "GET",
      fmt.Sprintf("/api/v1/orgs/%v/setting/mist_scep/client_certs", orgId),
    )
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
...
func (o *OrgsSCEP) RevokeOrgIssuedClientCertificates(
    ...
    *http.Response,
    ...
    req := o.prepareRequest(
      ctx,
      "POST",
      fmt.Sprintf("/api/v1/orgs/%v/setting/mist_scep/client_certs/revoke", orgId),
    )
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
