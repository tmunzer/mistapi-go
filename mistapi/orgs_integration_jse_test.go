...
// TestOrgsIntegrationJSETestGetOrgJseInfo1 tests the behavior of the OrgsIntegrationJSE
func TestOrgsIntegrationJSETestGetOrgJseInfo1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsIntegrationJSETestGetOrgJseIntegration1 tests the behavior of the OrgsIntegrationJSE
func TestOrgsIntegrationJSETestGetOrgJseIntegration1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsIntegrationJSETestSetupOrgJseIntegration1 tests the behavior of the OrgsIntegrationJSE
func TestOrgsIntegrationJSETestSetupOrgJseIntegration1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
