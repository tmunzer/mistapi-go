...
// TestOrgsPremiumAnalyticsTestListOrgPmaDashboards1 tests the behavior of the OrgsPremiumAnalytics
func TestOrgsPremiumAnalyticsTestListOrgPmaDashboards1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
