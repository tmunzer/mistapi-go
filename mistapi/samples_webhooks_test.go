...
// TestSamplesWebhooksTestGuestAuthorization tests the behavior of the SamplesWebhooks
func TestSamplesWebhooksTestGuestAuthorization(t *testing.T) {
    ctx := context.Background()
    var body models.WebhookGuestAuthorizations
    errBody := json.Unmarshal([]byte(`{"events":[{"ap":"5c5b350e55c8","auth_method":"passphrase","authorized_expiring_time":1677076639,"authorized_time":1677076519,"carrier":"docomo","client":"ac2316eca70a","company":"MIST","email":"abcd@abcd.com","field1":"field1 value","field2":"field2 value","field3":"field3 value","field4":"field4 value","mobile":"+0123456789","name":"Dr Strange","org_id":"1688605f-916a-47a1-8c68-f19618300a08","site_id":"ec3b5624-73f1-4ed3-b3fd-5ba3ee40368a","sms_gateway":"Telstra","sponsor_email":"sponsor@gmail.com","ssid":"Portal Auth","wlan_id":"7681be9a-044a-4622-90cf-3accde5ad853"}],"topic":"guest-authorizations"}`), &body)
    if errBody != nil {
        t.Errorf("Cannot parse the model object.")
    }
...
func TestSamplesWebhooksTestNacEvents(t *testing.T) {
    ...
    errBody := json.Unmarshal([]byte(`{"events":[{"ap":"5c5b35513227","auth_type":"eap-teap","bssid":"5c5b355fafcc","dryrun_nacrule_id":"32f27e7d-ff26-4a9b-b3d1-ff9bcb264012","dryrun_nacrule_matched":true,"idp_id":"912ef72e-2239-4996-b81e-469e87a27cd6","idp_role":["itsuperusers","vip"],"mac":"ac3eb179e535","nacrule_id":"32f27e7d-ff26-4a9b-b3d1-ff9bcb264c62","nacrule_matched":true,"nas_vendor":"juniper-mist","org_id":"27547ac2-d114-4e04-beb1-f3f1e6e81ec6","random_mac":true,"resp_attrs":["Tunnel-Type=VLAN","Tunnel-Medium-Type=IEEE-802","Tunnel-Private-Group-Id=750","User-Name=anonymous"],"site_id":"441a1214-6928-442a-8e92-e1d34b8ec6a6","ssid":"##mist_nac","timestamp":1691512031.358188,"type":"NAC_CLIENT_PERMIT","username":"user@deaflyz.net","vlan":"750"}],"topic":"string"}`), &body)
    if errBody != nil {
        t.Errorf("Cannot parse the model object.")
    }
