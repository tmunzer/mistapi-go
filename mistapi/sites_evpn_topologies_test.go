...
// TestSitesEVPNTopologiesTestListSiteEvpnTopologies1 tests the behavior of the SitesEVPNTopologies
func TestSitesEVPNTopologiesTestListSiteEvpnTopologies1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesEVPNTopologiesTestCreateSiteEvpnTopology1 tests the behavior of the SitesEVPNTopologies
func TestSitesEVPNTopologiesTestCreateSiteEvpnTopology1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesEVPNTopologiesTestGetSiteEvpnTopology1 tests the behavior of the SitesEVPNTopologies
func TestSitesEVPNTopologiesTestGetSiteEvpnTopology1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesEVPNTopologiesTestUpdateSiteEvpnTopology1 tests the behavior of the SitesEVPNTopologies
func TestSitesEVPNTopologiesTestUpdateSiteEvpnTopology1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
