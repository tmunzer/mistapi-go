...
func TestAdminsTestRegisterNewAdmin(t *testing.T) {
	...
	errBody := json.Unmarshal([]byte(`{"account_only":false,"allow_mist":false,"city":"Cupertino","country":"United States","email":"test@mistsys.com","first_name":"John","invite_code":"MISTROCKS","last_name":"Smith","no_tracking":false,"org_name":"Smith LLC","password":"foryoureyesonly","recaptcha":"string","recaptcha_flavor":"hcaptcha","referer_invite_token":"Dm2gtT8dwMeM4Bc2E8FLIaA96VHOjPat","return_to":"https://mist.zendesk.com/hc/quickstart.pdf","state":"California","street_address":"1601 S De Anza Blvd Ste 248","street_address 2":"1601 S De Anza Blvd Ste 248","zipcode":"95014"}`), &body)
	if errBody != nil {
