...
// TestOrgsDevicesOthersTestListOrgOtherDevices1 tests the behavior of the OrgsDevicesOthers
func TestOrgsDevicesOthersTestListOrgOtherDevices1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsDevicesOthersTestCountOrgOtherDeviceEvents1 tests the behavior of the OrgsDevicesOthers
func TestOrgsDevicesOthersTestCountOrgOtherDeviceEvents1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
func TestOrgsDevicesOthersTestSearchOrgOtherDeviceEvents(t *testing.T) {
	...
	apiResponse, err := orgsDevicesOthers.SearchOrgOtherDeviceEvents(ctx, orgId, nil, nil, nil, nil, nil, nil, &limit, nil, nil, &duration, &sort, nil)
	if err != nil {
		t.Errorf("Endpoint call failed: %v", err)
	}
	testHelper.CheckResponseStatusCode(t, apiResponse.Response.StatusCode, 200)
...
// TestOrgsDevicesOthersTestSearchOrgOtherDeviceEvents1 tests the behavior of the OrgsDevicesOthers
func TestOrgsDevicesOthersTestSearchOrgOtherDeviceEvents1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsDevicesOthersTestGetOrgOtherDevice1 tests the behavior of the OrgsDevicesOthers
func TestOrgsDevicesOthersTestGetOrgOtherDevice1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
