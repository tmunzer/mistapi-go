...
// TestSelfAPITokenTestListApiTokens1 tests the behavior of the SelfAPIToken
func TestSelfAPITokenTestListApiTokens1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := selfApiToken.ListApiTokens(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestSelfAPITokenTestCreateApiToken1 tests the behavior of the SelfAPIToken
func TestSelfAPITokenTestCreateApiToken1(t *testing.T) {
    ctx := context.Background()
    var body models.UserApitoken
    errBody := json.Unmarshal([]byte(`{"name":"org_token_xyz"}`), &body)
    if errBody != nil {
...
// TestSelfAPITokenTestGetApiToken1 tests the behavior of the SelfAPIToken
func TestSelfAPITokenTestGetApiToken1(t *testing.T) {
    ctx := context.Background()
    apitokenId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSelfAPITokenTestUpdateApiToken1 tests the behavior of the SelfAPIToken
func TestSelfAPITokenTestUpdateApiToken1(t *testing.T) {
    ctx := context.Background()
    apitokenId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
