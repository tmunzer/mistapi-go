...
type Wlan struct {
	...
	DisableMessageAuthenticatorCheck *bool `json:"disable_message_authenticator_check,omitempty"`
...
func (w Wlan) toMap() map[string]any {
	...
	if w.DisableMessageAuthenticatorCheck != nil {
		structMap["disable_message_authenticator_check"] = w.DisableMessageAuthenticatorCheck
	}
...
func (w *Wlan) UnmarshalJSON(input []byte) error {
	...
	w.DisableMessageAuthenticatorCheck = temp.DisableMessageAuthenticatorCheck
