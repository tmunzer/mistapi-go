...
// String implements the fmt.Stringer interface for ResponseEventsNacClientSearch,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (r ResponseEventsNacClientSearch) String() string {
	return fmt.Sprintf(
		"ResponseEventsNacClientSearch[End=%v, Limit=%v, Next=%v, Results=%v, Start=%v, Total=%v, AdditionalProperties=%v]",
