...
func (s SwitchMgmt) String() string {
	return fmt.Sprintf(
		"SwitchMgmt[ApAffinityThreshold=%v, CliBanner=%v, CliIdleTimeout=%v, ConfigRevertTimer=%v, DhcpOptionFqdn=%v, DisableOobDownAlarm=%v, FipsEnabled=%v, LocalAccounts=%v, MxedgeProxyHost=%v, MxedgeProxyPort=%v, ProtectRe=%v, Radius=%v, RemoveExistingConfigs=%v, RootPassword=%v, Tacacs=%v, UseMxedgeProxy=%v, AdditionalProperties=%v]",
		s.ApAffinityThreshold, s.CliBanner, s.CliIdleTimeout, s.ConfigRevertTimer, s.DhcpOptionFqdn, s.DisableOobDownAlarm, s.FipsEnabled, s.LocalAccounts, s.MxedgeProxyHost, s.MxedgeProxyPort, s.ProtectRe, s.Radius, s.RemoveExistingConfigs, s.RootPassword, s.Tacacs, s.UseMxedgeProxy, s.AdditionalProperties)
}
...
func (s SwitchMgmt) MarshalJSON() (
	...
	if err := DetectConflictingProperties(s.AdditionalProperties,
		"ap_affinity_threshold", "cli_banner", "cli_idle_timeout", "config_revert_timer", "dhcp_option_fqdn", "disable_oob_down_alarm", "fips_enabled", "local_accounts", "mxedge_proxy_host", "mxedge_proxy_port", "protect_re", "radius", "remove_existing_configs", "root_password", "tacacs", "use_mxedge_proxy"); err != nil {
		return []byte{}, err
	}
...
func (s *SwitchMgmt) UnmarshalJSON(input []byte) error {
	...
	additionalProperties, err := ExtractAdditionalProperties[interface{}](input, "ap_affinity_threshold", "cli_banner", "cli_idle_timeout", "config_revert_timer", "dhcp_option_fqdn", "disable_oob_down_alarm", "fips_enabled", "local_accounts", "mxedge_proxy_host", "mxedge_proxy_port", "protect_re", "radius", "remove_existing_configs", "root_password", "tacacs", "use_mxedge_proxy")
	if err != nil {
		return err
	}
