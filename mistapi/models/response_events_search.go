...
// responseEventsSearch is a temporary struct used for validating the fields of ResponseEventsSearch.
type responseEventsSearch  struct {
    End     *int            `json:"end"`
    Limit   *int            `json:"limit"`
    Next    *string         `json:"next,omitempty"`
...
func (r *responseEventsSearch) validate() error {
    var errs []string
    if r.End == nil {
