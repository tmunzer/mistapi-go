...
// String implements the fmt.Stringer interface for ResponsePortStatsSearch,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (r ResponsePortStatsSearch) String() string {
    return fmt.Sprintf(
    	"ResponsePortStatsSearch[End=%v, Limit=%v, Next=%v, Results=%v, Start=%v, Total=%v, AdditionalProperties=%v]",
