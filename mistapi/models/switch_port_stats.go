...
// SwitchPortStats represents a SwitchPortStats struct.
...
// MarshalJSON implements the json.Marshaler interface for SwitchPortStats.
// It customizes the JSON marshaling process for SwitchPortStats objects.
func (s SwitchPortStats) MarshalJSON() (
    []byte,
    error) {
    return json.Marshal(s.toMap())
}

// toMap converts the SwitchPortStats object to a map representation for JSON marshaling.
func (s SwitchPortStats) toMap() map[string]any {
