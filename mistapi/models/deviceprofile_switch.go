...
func (d DeviceprofileSwitch) String() string {
    return fmt.Sprintf(
    	"DeviceprofileSwitch[AclPolicies=%v, AclTags=%v, AdditionalConfigCmds=%v, CreatedTime=%v, DhcpSnooping=%v, DhcpdConfig=%v, DnsServers=%v, DnsSuffix=%v, EvpnConfig=%v, ExtraRoutes=%v, ExtraRoutes6=%v, Id=%v, IpConfig=%v, LocalPortConfig=%v, MistNac=%v, ModifiedTime=%v, Name=%v, Networks=%v, NtpServers=%v, OobIpConfig=%v, OrgId=%v, OspfAreas=%v, OtherIpConfigs=%v, PortConfig=%v, PortUsages=%v, RadiusConfig=%v, RemoteSyslog=%v, SiteId=%v, SnmpConfig=%v, StpConfig=%v, SwitchMgmt=%v, Type=%v, UseRouterIdAsSourceIp=%v, VrfConfig=%v, VrfInstances=%v, VrrpConfig=%v, AdditionalProperties=%v]",
    	d.AclPolicies, d.AclTags, d.AdditionalConfigCmds, d.CreatedTime, d.DhcpSnooping, d.DhcpdConfig, d.DnsServers, d.DnsSuffix, d.EvpnConfig, d.ExtraRoutes, d.ExtraRoutes6, d.Id, d.IpConfig, d.LocalPortConfig, d.MistNac, d.ModifiedTime, d.Name, d.Networks, d.NtpServers, d.OobIpConfig, d.OrgId, d.OspfAreas, d.OtherIpConfigs, d.PortConfig, d.PortUsages, d.RadiusConfig, d.RemoteSyslog, d.SiteId, d.SnmpConfig, d.StpConfig, d.SwitchMgmt, d.Type, d.UseRouterIdAsSourceIp, d.VrfConfig, d.VrfInstances, d.VrrpConfig, d.AdditionalProperties)
}
...
func (d DeviceprofileSwitch) MarshalJSON() (
    ...
    if err := DetectConflictingProperties(d.AdditionalProperties,
        "acl_policies", "acl_tags", "additional_config_cmds", "created_time", "dhcp_snooping", "dhcpd_config", "dns_servers", "dns_suffix", "evpn_config", "extra_routes", "extra_routes6", "id", "ip_config", "local_port_config", "mist_nac", "modified_time", "name", "networks", "ntp_servers", "oob_ip_config", "org_id", "ospf_areas", "other_ip_configs", "port_config", "port_usages", "radius_config", "remote_syslog", "site_id", "snmp_config", "stp_config", "switch_mgmt", "type", "use_router_id_as_source_ip", "vrf_config", "vrf_instances", "vrrp_config"); err != nil {
        return []byte{}, err
    }
...
func (d *DeviceprofileSwitch) UnmarshalJSON(input []byte) error {
    ...
    additionalProperties, err := ExtractAdditionalProperties[interface{}](input, "acl_policies", "acl_tags", "additional_config_cmds", "created_time", "dhcp_snooping", "dhcpd_config", "dns_servers", "dns_suffix", "evpn_config", "extra_routes", "extra_routes6", "id", "ip_config", "local_port_config", "mist_nac", "modified_time", "name", "networks", "ntp_servers", "oob_ip_config", "org_id", "ospf_areas", "other_ip_configs", "port_config", "port_usages", "radius_config", "remote_syslog", "site_id", "snmp_config", "stp_config", "switch_mgmt", "type", "use_router_id_as_source_ip", "vrf_config", "vrf_instances", "vrrp_config")
    if err != nil {
    	return err
    }
