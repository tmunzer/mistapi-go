...
// Events specific fields for other alarm event type can be found with API [List Alarm Definitions#]($e/Constants%20Definitions/listAlarmDefinitions), under "fields" array of /alarm_defs response object.
