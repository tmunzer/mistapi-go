...
type SiteTemplateAutoUpgrade struct {
	...
	// Whether automatic upgrades are enabled for sites using this site template
	Enabled *bool `json:"enabled,omitempty"`
	// Local time of day when the automatic upgrade window starts
	TimeOfDay *string `json:"time_of_day,omitempty"`
	// Target firmware version installed during automatic upgrades
