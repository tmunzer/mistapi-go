...
type ResponseEventsOtherDevicesSearch struct {
	// Epoch timestamp for the end of the other-device event search window
	End *int `json:"end,omitempty"`
	// Maximum number of other-device event records returned in this page
	Limit *int `json:"limit,omitempty"`
	// Pagination cursor or URL for retrieving the next page of other-device event records
	Next *string `json:"next,omitempty"`
	// Other-device event records returned by a search response
	Results []EventOtherdevice `json:"results,omitempty"`
	// Epoch timestamp for the start of the other-device event search window
	Start *int `json:"start,omitempty"`
	// Number of other-device event records matching the search filters across all pages
...
func (r ResponseEventsOtherDevicesSearch) String() string {
	return fmt.Sprintf(
		"ResponseEventsOtherDevicesSearch[End=%v, Limit=%v, Next=%v, Results=%v, Start=%v, Total=%v, AdditionalProperties=%v]",
