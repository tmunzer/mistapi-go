...
// ModuleStatItem1 represents a ModuleStatItem1 struct.
type ModuleStatItem1 struct {
    ...
    Psus                 []ClusterConfigStatsControlLinkInfo `json:"psus,omitempty"`
...
// MarshalJSON implements the json.Marshaler interface for ModuleStatItem1.
// It customizes the JSON marshaling process for ModuleStatItem1 objects.
func (m ModuleStatItem1) MarshalJSON() (
    []byte,
    error) {
    return json.Marshal(m.toMap())
}

// toMap converts the ModuleStatItem1 object to a map representation for JSON marshaling.
func (m ModuleStatItem1) toMap() map[string]any {
...
// UnmarshalJSON implements the json.Unmarshaler interface for ModuleStatItem1.
// It customizes the JSON unmarshaling process for ModuleStatItem1 objects.
func (m *ModuleStatItem1) UnmarshalJSON(input []byte) error {
    var temp tempModuleStatItem1
...
// tempModuleStatItem1 is a temporary struct used for validating the fields of ModuleStatItem1.
type tempModuleStatItem1  struct {
    BackupVersion     Optional[string]                    `json:"backup_version"`
    BiosVersion       Optional[string]                    `json:"bios_version"`
    CpldVersion       Optional[string]                    `json:"cpld_version"`
    Errors            []ModuleStatItemErrorsItems         `json:"errors,omitempty"`
