...
type EventOtherdevice struct {
	// Attached device MAC address associated with the other-device event
	DeviceMac *string `json:"device_mac,omitempty"`
	// Other-device MAC address associated with the event
	Mac *string `json:"mac,omitempty"`
	// Unique identifier of a Mist organization
	OrgId *uuid.UUID `json:"org_id,omitempty"`
	// Unique identifier of a Mist site
	SiteId *uuid.UUID `json:"site_id,omitempty"`
	// Human-readable message for the other-device event
	Text *string `json:"text,omitempty"`
	// Epoch timestamp, in seconds
	Timestamp *float64 `json:"timestamp,omitempty"`
	// Event type for the other-device event
	Type *string `json:"type,omitempty"`
	// Manufacturer or vendor name reported for the other device
