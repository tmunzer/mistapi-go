...
type SiteSettingDerived struct {
	...
	Mxtunnel *SiteMxtunnel `json:"mxtunnel,omitempty"`
...
func (s SiteSettingDerived) toMap() map[string]any {
	...
	if s.Mxtunnel != nil {
		structMap["mxtunnel"] = s.Mxtunnel.toMap()
	}
	if s.Networks != nil {
	...
	if s.UwbConfig != nil {
		structMap["uwb_config"] = s.UwbConfig.toMap()
	}
	if s.Vars != nil {
	...
	if s.AccountId != nil {
		structMap["account_id"] = s.AccountId
	}
	if s.AutoProbeSubnet != nil {
		structMap["auto_probe_subnet"] = s.AutoProbeSubnet
	}
	if s.ClientId != nil {
		structMap["client_id"] = s.ClientId
	}
	if s.CloudName != nil {
		structMap["cloud_name"] = s.CloudName
	}
	if s.Company != nil {
		structMap["company"] = s.Company
	}
	if s.EnableProbe != nil {
		structMap["enable_probe"] = s.EnableProbe
	}
	if s.Error != nil {
	...
	if s.InstanceUrl != nil {
		structMap["instance_url"] = s.InstanceUrl
	}
	if s.KeyId != nil {
		structMap["key_id"] = s.KeyId
	}
	if s.LastStatus != nil {
		structMap["last_status"] = s.LastStatus
	}
	if s.LastSync != nil {
		structMap["last_sync"] = s.LastSync
	}
	if s.LinkedBy != nil {
		structMap["linked_by"] = s.LinkedBy
	}
	if s.LinkedTimestamp != nil {
		structMap["linked_timestamp"] = s.LinkedTimestamp
	}
	if s.MaxDailyApiRequests != nil {
		structMap["max_daily_api_requests"] = s.MaxDailyApiRequests
	}
	if s.Name != nil {
	...
	if s.ServiceConnections != nil {
		structMap["service_connections"] = s.ServiceConnections
	}
	if s.SmartgroupName != nil {
		structMap["smartgroup_name"] = s.SmartgroupName
	}
	if s.TsgId != nil {
		structMap["tsg_id"] = s.TsgId
	}
	if s.Username != nil {
		structMap["username"] = s.Username
	}
	if s.WebhookAuthType != nil {
		structMap["webhook_auth_type"] = s.WebhookAuthType
	}
	if s.WebhookEnabled != nil {
		structMap["webhook_enabled"] = s.WebhookEnabled
	}
	if s.WebhookPassword != nil {
		structMap["webhook_password"] = s.WebhookPassword
	}
	if s.WebhookSecret != nil {
		structMap["webhook_secret"] = s.WebhookSecret
	}
	if s.WebhookToken != nil {
		structMap["webhook_token"] = s.WebhookToken
	}
	if s.WebhookUrl != nil {
		structMap["webhook_url"] = s.WebhookUrl
	}
	if s.WebhookUsername != nil {
		structMap["webhook_username"] = s.WebhookUsername
	}
	if s.ZdxOrgId != nil {
		structMap["zdx_org_id"] = s.ZdxOrgId
	}
	return structMap
}

// UnmarshalJSON implements the json.Unmarshaler interface for SiteSettingDerived.
// It customizes the JSON unmarshaling process for SiteSettingDerived objects.
func (s *SiteSettingDerived) UnmarshalJSON(input []byte) error {
	var temp tempSiteSettingDerived
	err := json.Unmarshal(input, &temp)
	if err != nil {
		return err
	}
	additionalProperties, err := ExtractAdditionalProperties[AccountOauthInfoAccount](input, "acl_policies", "acl_tags", "additional_config_cmds", "allow_mist", "analytic", "ap_matching", "ap_port_config", "ap_synthetic_test", "ap_updown_threshold", "auto_placement", "auto_upgrade", "auto_upgrade_esl", "auto_upgrade_linecard", "bgp_neighbor_updown_threshold", "blacklist_url", "ble_config", "config_auto_revert", "config_push_policy", "created_time", "critical_url_monitoring", "device_updown_threshold", "dhcp_snooping", "disabled_system_defined_port_usages", "dns_servers", "dns_suffix", "enable_unii_4", "engagement", "evpn_options", "extra_routes", "extra_routes6", "flags", "for_site", "gateway", "gateway_additional_config_cmds", "gateway_mgmt", "gateway_tunnel_updown_threshold", "gateway_updown_threshold", "id", "iotproxy", "juniper_srx", "led", "marvis", "mist_nac", "modified_time", "mxedge", "mxedge_mgmt", "mxtunnel", "networks", "ntp_servers", "occupancy", "org_id", "ospf_areas", "paloalto_networks", "persist_config_on_device", "port_mirroring", "port_usages", "proxy", "radio_config", "radius_config", "remote_syslog", "remove_existing_configs", "report_gatt", "rogue", "routing_policies", "rtsa", "simple_alert", "site_id", "skyatp", "sle_thresholds", "snmp_config", "srx_app", "ssh_keys", "ssr", "status_portal", "switch", "switch_matching", "switch_mgmt", "switch_updown_threshold", "synthetic_test", "track_anonymous_devices", "tunterm_monitoring", "tunterm_monitoring_disabled", "tunterm_multicast_config", "uplink_port_config", "uses_description_from_port_usage", "uwb_config", "vars", "vars_annotations", "vna", "vpn_path_updown_threshold", "vpn_peer_updown_threshold", "vrf_config", "vrf_instances", "vrrp_groups", "vs_instance", "wan_vna", "watched_station_url", "whitelist_url", "wids", "wifi", "wired_vna", "zone_occupancy_alert", "account_id", "auto_probe_subnet", "client_id", "cloud_name", "company", "enable_probe", "error", "errors", "instance_url", "key_id", "last_status", "last_sync", "linked_by", "linked_timestamp", "max_daily_api_requests", "name", "password", "region", "regions", "service_account_name", "service_connections", "smartgroup_name", "tsg_id", "username", "webhook_auth_type", "webhook_enabled", "webhook_password", "webhook_secret", "webhook_token", "webhook_url", "webhook_username", "zdx_org_id")
	if err != nil {
		return err
	}
	...
	s.AccountId = temp.AccountId
	s.AutoProbeSubnet = temp.AutoProbeSubnet
	s.ClientId = temp.ClientId
	s.CloudName = temp.CloudName
	s.Company = temp.Company
	s.EnableProbe = temp.EnableProbe
	s.Error = temp.Error
	s.Errors = temp.Errors
	s.InstanceUrl = temp.InstanceUrl
	s.KeyId = temp.KeyId
	s.LastStatus = temp.LastStatus
	s.LastSync = temp.LastSync
	s.LinkedBy = temp.LinkedBy
	s.LinkedTimestamp = temp.LinkedTimestamp
	s.MaxDailyApiRequests = temp.MaxDailyApiRequests
	s.Name = temp.Name
	...
	s.WebhookAuthType = temp.WebhookAuthType
	s.WebhookEnabled = temp.WebhookEnabled
	s.WebhookPassword = temp.WebhookPassword
	s.WebhookSecret = temp.WebhookSecret
	s.WebhookToken = temp.WebhookToken
	s.WebhookUrl = temp.WebhookUrl
	s.WebhookUsername = temp.WebhookUsername
	s.ZdxOrgId = temp.ZdxOrgId
	return nil
}
