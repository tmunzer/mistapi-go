...
type ClientWireless struct {
	...
	// Wi-Fi radio band used by the wireless client
	Band *string `json:"band,omitempty"`
	// Only when client has the Marvis Client app running. List of the type of device type detected
	Device []string `json:"device,omitempty"`
	// Whether fast transition information is reported for the wireless client
	...
	// Most recent username associated with the wireless client
	...
	// Client MAC address for the wireless client
	...
	// 802.11 protocol amendment used by the wireless client
	...
	// Whether the wireless client uses a randomized MAC address
