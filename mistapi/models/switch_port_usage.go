...
func (s SwitchPortUsage) toMap() map[string]any {
    ...
    if s.BypassAuthWhenServerDownForUnkownClient != nil {
        structMap["bypass_auth_when_server_down_for_unkown_client"] = s.BypassAuthWhenServerDownForUnkownClient
    }
...
func (s *SwitchPortUsage) UnmarshalJSON(input []byte) error {
    ...
    s.BypassAuthWhenServerDownForUnkownClient = temp.BypassAuthWhenServerDownForUnkownClient
