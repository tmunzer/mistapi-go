...
type Sso struct {
	...
	OpenroamingSsids []string `json:"openroaming_ssids,omitempty"`
	...
	OpenroamingWbaClientCert *string `json:"openroaming_wba_client_cert,omitempty"`
	...
	OpenroamingWbaClientKey *string `json:"openroaming_wba_client_key,omitempty"`
...
func (s Sso) toMap() map[string]any {
	...
	if s.OpenroamingSsids != nil {
		structMap["openroaming_ssids"] = s.OpenroamingSsids
	}
	if s.OpenroamingWbaClientCert != nil {
		structMap["openroaming_wba_client_cert"] = s.OpenroamingWbaClientCert
	}
	if s.OpenroamingWbaClientKey != nil {
		structMap["openroaming_wba_client_key"] = s.OpenroamingWbaClientKey
	}
	if s.OrgId != nil {
...
func (s *Sso) UnmarshalJSON(input []byte) error {
	...
	additionalProperties, err := ExtractAdditionalProperties[interface{}](input, "created_time", "custom_logout_url", "default_role", "domain", "group_filter", "id", "idp_cert", "idp_sign_algo", "idp_sso_url", "idp_type", "ignore_unmatched_roles", "issuer", "ldap_base_dn", "ldap_bind_dn", "ldap_bind_password", "ldap_cacerts", "ldap_client_cert", "ldap_client_key", "ldap_group_attr", "ldap_group_dn", "ldap_resolve_groups", "ldap_server_hosts", "ldap_type", "ldap_user_filter", "member_filter", "modified_time", "msp_id", "mxedge_proxy", "name", "nameid_format", "oauth_cc_client_id", "oauth_cc_client_secret", "oauth_discovery_url", "oauth_ping_identity_region", "oauth_provider_domain", "oauth_ropc_client_id", "oauth_ropc_client_secret", "oauth_tenant_id", "oauth_type", "openroaming_ssids", "openroaming_wba_client_cert", "openroaming_wba_client_key", "org_id", "role_attr_extraction", "role_attr_from", "scim_enabled", "scim_secret_token", "site_id")
	if err != nil {
		return err
	}
	...
	s.OpenroamingSsids = temp.OpenroamingSsids
	s.OpenroamingWbaClientCert = temp.OpenroamingWbaClientCert
	s.OpenroamingWbaClientKey = temp.OpenroamingWbaClientKey
	s.OrgId = temp.OrgId
