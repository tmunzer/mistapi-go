...
func (r RemoteSyslog) String() string {
	return fmt.Sprintf(
		"RemoteSyslog[Archive=%v, Cacerts=%v, Console=%v, Enabled=%v, Files=%v, Network=%v, SendToAllServers=%v, Servers=%v, TimeFormat=%v, Users=%v, AdditionalProperties=%v]",
		r.Archive, r.Cacerts, r.Console, r.Enabled, r.Files, r.Network, r.SendToAllServers, r.Servers, r.TimeFormat, r.Users, r.AdditionalProperties)
}
...
func (r RemoteSyslog) MarshalJSON() (
	...
	if err := DetectConflictingProperties(r.AdditionalProperties,
		"archive", "cacerts", "console", "enabled", "files", "network", "send_to_all_servers", "servers", "time_format", "users"); err != nil {
		return []byte{}, err
	}
...
func (r *RemoteSyslog) UnmarshalJSON(input []byte) error {
	...
	additionalProperties, err := ExtractAdditionalProperties[interface{}](input, "archive", "cacerts", "console", "enabled", "files", "network", "send_to_all_servers", "servers", "time_format", "users")
	if err != nil {
		return err
	}
