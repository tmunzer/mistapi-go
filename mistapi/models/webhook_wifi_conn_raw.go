...
// WebhookWifiConnRaw represents a WebhookWifiConnRaw struct.
...
// String implements the fmt.Stringer interface for WebhookWifiConnRaw,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (w WebhookWifiConnRaw) String() string {
	return fmt.Sprintf(
		"WebhookWifiConnRaw[Events=%v, Topic=%v, AdditionalProperties=%v]",
		w.Events, w.Topic, w.AdditionalProperties)
}

// MarshalJSON implements the json.Marshaler interface for WebhookWifiConnRaw.
// It customizes the JSON marshaling process for WebhookWifiConnRaw objects.
func (w WebhookWifiConnRaw) MarshalJSON() (
	[]byte,
	error) {
...
// toMap converts the WebhookWifiConnRaw object to a map representation for JSON marshaling.
func (w WebhookWifiConnRaw) toMap() map[string]any {
...
// UnmarshalJSON implements the json.Unmarshaler interface for WebhookWifiConnRaw.
// It customizes the JSON unmarshaling process for WebhookWifiConnRaw objects.
func (w *WebhookWifiConnRaw) UnmarshalJSON(input []byte) error {
	var temp tempWebhookWifiConnRaw
...
// tempWebhookWifiConnRaw is a temporary struct used for validating the fields of WebhookWifiConnRaw.
type tempWebhookWifiConnRaw struct {
	Events *[]WebhookWifiConnRawEvent `json:"events"`
	Topic  *string                    `json:"topic"`
}

func (w *tempWebhookWifiConnRaw) validate() error {
	var errs []string
	if w.Events == nil {
		errs = append(errs, "required field `events` is missing for type `webhook_wifi_conn_raw`")
	}
	if w.Topic == nil {
		errs = append(errs, "required field `topic` is missing for type `webhook_wifi_conn_raw`")
	}
	if len(errs) == 0 {
		return nil
	}
