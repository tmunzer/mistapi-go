...
// TestSitesStatsOspfTestSearchSiteOspfStats tests the behavior of the SitesStatsOspf
func TestSitesStatsOspfTestSearchSiteOspfStats(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestSitesStatsOspfTestSearchSiteOspfStats1 tests the behavior of the SitesStatsOspf
func TestSitesStatsOspfTestSearchSiteOspfStats1(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
