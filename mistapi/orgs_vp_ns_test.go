...
// TestOrgsVPNsTestListOrgVpns1 tests the behavior of the OrgsVPNs
func TestOrgsVPNsTestListOrgVpns1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsVPNsTestCreateOrgVpn1 tests the behavior of the OrgsVPNs
func TestOrgsVPNsTestCreateOrgVpn1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsVPNsTestGetOrgVpn1 tests the behavior of the OrgsVPNs
func TestOrgsVPNsTestGetOrgVpn1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsVPNsTestUpdateOrgVpn1 tests the behavior of the OrgsVPNs
func TestOrgsVPNsTestUpdateOrgVpn1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
