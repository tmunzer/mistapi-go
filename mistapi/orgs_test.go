...
// TestOrgsTestCreateOrg1 tests the behavior of the Orgs
func TestOrgsTestCreateOrg1(t *testing.T) {
    ctx := context.Background()
    var body models.Org
    errBody := json.Unmarshal([]byte(`{"alarmtemplate_id":"b069b358-4c97-5319-1f8c-7c5ca64d6ab1","allow_mist":true,"name":"string","session_expiry":1440}`), &body)
    if errBody != nil {
...
// TestOrgsTestGetOrg1 tests the behavior of the Orgs
func TestOrgsTestGetOrg1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsTestUpdateOrg1 tests the behavior of the Orgs
func TestOrgsTestUpdateOrg1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsTestCloneOrg1 tests the behavior of the Orgs
func TestOrgsTestCloneOrg1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
