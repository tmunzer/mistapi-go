...
func (s *SitesAssetFilters) ListSiteAssetFilters(
	...
	error) {
	req := s.prepareRequest(ctx, "GET", "/api/v1/sites/%v/assetfilters")
...
func (s *SitesAssetFilters) CreateSiteAssetFilter(
	...
	models.ApiResponse[models.AssetFilter],
	error) {
	req := s.prepareRequest(ctx, "POST", "/api/v1/sites/%v/assetfilters")
	req.AppendTemplateParams(siteId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (s *SitesAssetFilters) DeleteSiteAssetFilter(
	...
	*http.Response,
	error) {
	req := s.prepareRequest(ctx, "DELETE", "/api/v1/sites/%v/assetfilters/%v")
	req.AppendTemplateParams(siteId, assetfilterId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
			NewAuth("basicAuth"),
...
func (s *SitesAssetFilters) GetSiteAssetFilter(
	...
	models.ApiResponse[models.AssetFilter],
	error) {
	req := s.prepareRequest(ctx, "GET", "/api/v1/sites/%v/assetfilters/%v")
	req.AppendTemplateParams(siteId, assetfilterId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (s *SitesAssetFilters) UpdateSiteAssetFilter(
	...
	models.ApiResponse[models.AssetFilter],
	error) {
	req := s.prepareRequest(ctx, "PUT", "/api/v1/sites/%v/assetfilters/%v")
	req.AppendTemplateParams(siteId, assetfilterId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
