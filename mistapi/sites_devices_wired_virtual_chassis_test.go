...
// TestSitesDevicesWiredVirtualChassisTestChangeSiteSwitchVcPortMode tests the behavior of the SitesDevicesWiredVirtualChassis
func TestSitesDevicesWiredVirtualChassisTestChangeSiteSwitchVcPortMode(t *testing.T) {
...
// TestSitesDevicesWiredVirtualChassisTestConvertSiteVirtualChassisToVirtualMac tests the behavior of the SitesDevicesWiredVirtualChassis
func TestSitesDevicesWiredVirtualChassisTestConvertSiteVirtualChassisToVirtualMac(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
