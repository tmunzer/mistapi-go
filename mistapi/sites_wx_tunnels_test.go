...
// TestSitesWxTunnelsTestListSiteWxTunnels1 tests the behavior of the SitesWxTunnels
func TestSitesWxTunnelsTestListSiteWxTunnels1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesWxTunnelsTestCreateSiteWxTunnel1 tests the behavior of the SitesWxTunnels
func TestSitesWxTunnelsTestCreateSiteWxTunnel1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesWxTunnelsTestGetSiteWxTunnel1 tests the behavior of the SitesWxTunnels
func TestSitesWxTunnelsTestGetSiteWxTunnel1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesWxTunnelsTestUpdateSiteWxTunnel1 tests the behavior of the SitesWxTunnels
func TestSitesWxTunnelsTestUpdateSiteWxTunnel1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
