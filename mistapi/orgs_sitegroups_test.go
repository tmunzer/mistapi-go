...
// TestOrgsSitegroupsTestListOrgSiteGroups1 tests the behavior of the OrgsSitegroups
func TestOrgsSitegroupsTestListOrgSiteGroups1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsSitegroupsTestCreateOrgSiteGroup1 tests the behavior of the OrgsSitegroups
func TestOrgsSitegroupsTestCreateOrgSiteGroup1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsSitegroupsTestGetOrgSiteGroup1 tests the behavior of the OrgsSitegroups
func TestOrgsSitegroupsTestGetOrgSiteGroup1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestOrgsSitegroupsTestUpdateOrgSiteGroup1 tests the behavior of the OrgsSitegroups
func TestOrgsSitegroupsTestUpdateOrgSiteGroup1(t *testing.T) {
    ctx := context.Background()
    orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
