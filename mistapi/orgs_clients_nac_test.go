...
// TestOrgsClientsNACTestSendOrgNacClientCoA tests the behavior of the OrgsClientsNAC
func TestOrgsClientsNACTestSendOrgNacClientCoA(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
	...
	apiResponse, err := orgsClientsNac.SendOrgNacClientCoA(ctx, orgId, clientMac, nil)
	if err != nil {
		t.Errorf("Endpoint call failed: %v", err)
	}
	testHelper.CheckResponseStatusCode(t, apiResponse.Response.StatusCode, 200)
...
// TestOrgsClientsNACTestSendOrgNacClientCoA1 tests the behavior of the OrgsClientsNAC
func TestOrgsClientsNACTestSendOrgNacClientCoA1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
