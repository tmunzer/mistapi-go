...
// TestSitesVBeaconsTestListSiteVBeacons1 tests the behavior of the SitesVBeacons
func TestSitesVBeaconsTestListSiteVBeacons1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesVBeaconsTestCreateSiteVBeacon1 tests the behavior of the SitesVBeacons
func TestSitesVBeaconsTestCreateSiteVBeacon1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesVBeaconsTestGetSiteVBeacon1 tests the behavior of the SitesVBeacons
func TestSitesVBeaconsTestGetSiteVBeacon1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
...
// TestSitesVBeaconsTestUpdateSiteVBeacon1 tests the behavior of the SitesVBeacons
func TestSitesVBeaconsTestUpdateSiteVBeacon1(t *testing.T) {
    ctx := context.Background()
    siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
    if errUUID != nil {
        t.Error(errUUID)
