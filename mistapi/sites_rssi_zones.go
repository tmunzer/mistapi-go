...
func (s *SitesRSSIZones) ListSiteRssiZones(
    ...
    error) {
    req := s.prepareRequest(ctx, "GET", "/api/v1/sites/%v/rssizones")
...
func (s *SitesRSSIZones) CreateSiteRssiZone(
    ...
    models.ApiResponse[models.RssiZone],
    error) {
    req := s.prepareRequest(ctx, "POST", "/api/v1/sites/%v/rssizones")
    req.AppendTemplateParams(siteId)
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
...
func (s *SitesRSSIZones) DeleteSiteRssiZone(
    ...
    *http.Response,
    error) {
    req := s.prepareRequest(ctx, "DELETE", "/api/v1/sites/%v/rssizones/%v")
    req.AppendTemplateParams(siteId, rssizoneId)
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
            NewAuth("basicAuth"),
...
func (s *SitesRSSIZones) GetSiteRssiZone(
    ...
    models.ApiResponse[[]models.RssiZone],
    error) {
    req := s.prepareRequest(ctx, "GET", "/api/v1/sites/%v/rssizones/%v")
    req.AppendTemplateParams(siteId, rssizoneId)
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
...
func (s *SitesRSSIZones) UpdateSiteRssiZone(
    ...
    models.ApiResponse[models.RssiZone],
    error) {
    req := s.prepareRequest(ctx, "PUT", "/api/v1/sites/%v/rssizones/%v")
    req.AppendTemplateParams(siteId, rssizoneId)
    req.Authenticate(
        NewOrAuth(
            NewAuth("apiToken"),
