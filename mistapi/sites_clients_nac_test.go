...
// TestSitesClientsNACTestSendSiteNacClientCoA tests the behavior of the SitesClientsNAC
func TestSitesClientsNACTestSendSiteNacClientCoA(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
	...
	apiResponse, err := sitesClientsNac.SendSiteNacClientCoA(ctx, siteId, clientMac, nil)
	if err != nil {
		t.Errorf("Endpoint call failed: %v", err)
	}
	testHelper.CheckResponseStatusCode(t, apiResponse.Response.StatusCode, 200)
...
// TestSitesClientsNACTestSendSiteNacClientCoA1 tests the behavior of the SitesClientsNAC
func TestSitesClientsNACTestSendSiteNacClientCoA1(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
