...
// TestOrgsNetworksTestCreateOrgNetwork1 tests the behavior of the OrgsNetworks
func TestOrgsNetworksTestCreateOrgNetwork1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNetworksTestGetOrgNetwork1 tests the behavior of the OrgsNetworks
func TestOrgsNetworksTestGetOrgNetwork1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsNetworksTestUpdateOrgNetwork1 tests the behavior of the OrgsNetworks
func TestOrgsNetworksTestUpdateOrgNetwork1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
