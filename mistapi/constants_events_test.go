...
// TestConstantsEventsTestListAlarmDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListAlarmDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListAlarmDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestConstantsEventsTestListClientEventsDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListClientEventsDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListClientEventsDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestConstantsEventsTestListDeviceEventsDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListDeviceEventsDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListDeviceEventsDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestConstantsEventsTestListMxEdgeEventsDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListMxEdgeEventsDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListMxEdgeEventsDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestConstantsEventsTestListNacEventsDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListNacEventsDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListNacEventsDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestConstantsEventsTestListOtherDeviceEventsDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListOtherDeviceEventsDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListOtherDeviceEventsDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
...
// TestConstantsEventsTestListSystemEventsDefinitions1 tests the behavior of the ConstantsEvents
func TestConstantsEventsTestListSystemEventsDefinitions1(t *testing.T) {
    ctx := context.Background()
    apiResponse, err := constantsEvents.ListSystemEventsDefinitions(ctx)
    if err != nil {
        t.Errorf("Endpoint call failed: %v", err)
