...
func (o *OrgsWxTunnels) ListOrgWxTunnels(
	...
	error) {
	req := o.prepareRequest(ctx, "GET", "/api/v1/orgs/%v/wxtunnels")
...
func (o *OrgsWxTunnels) CreateOrgWxTunnel(
	...
	models.ApiResponse[models.WxlanTunnel],
	error) {
	req := o.prepareRequest(ctx, "POST", "/api/v1/orgs/%v/wxtunnels")
	req.AppendTemplateParams(orgId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (o *OrgsWxTunnels) DeleteOrgWxTunnel(
	...
	*http.Response,
	error) {
	req := o.prepareRequest(ctx, "DELETE", "/api/v1/orgs/%v/wxtunnels/%v")
	req.AppendTemplateParams(orgId, wxtunnelId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
			NewAuth("basicAuth"),
...
func (o *OrgsWxTunnels) GetOrgWxTunnel(
	...
	models.ApiResponse[models.WxlanTunnel],
	error) {
	req := o.prepareRequest(ctx, "GET", "/api/v1/orgs/%v/wxtunnels/%v")
	req.AppendTemplateParams(orgId, wxtunnelId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
...
func (o *OrgsWxTunnels) UpdateOrgWxTunnel(
	...
	models.ApiResponse[models.WxlanTunnel],
	error) {
	req := o.prepareRequest(ctx, "PUT", "/api/v1/orgs/%v/wxtunnels/%v")
	req.AppendTemplateParams(orgId, wxtunnelId)
	req.Authenticate(
		NewOrAuth(
			NewAuth("apiToken"),
