...
// TestOrgsGuestsTestListOrgGuestAuthorizations1 tests the behavior of the OrgsGuests
func TestOrgsGuestsTestListOrgGuestAuthorizations1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsGuestsTestCountOrgGuestAuthorizations1 tests the behavior of the OrgsGuests
func TestOrgsGuestsTestCountOrgGuestAuthorizations1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsGuestsTestSearchOrgGuestAuthorization1 tests the behavior of the OrgsGuests
func TestOrgsGuestsTestSearchOrgGuestAuthorization1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestOrgsGuestsTestGetOrgGuestAuthorization1 tests the behavior of the OrgsGuests
func TestOrgsGuestsTestGetOrgGuestAuthorization1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
func TestOrgsGuestsTestUpdateOrgGuestAuthorization(t *testing.T) {
	...
	guestMac := "0000000000ab"
	var body models.GuestOrg
	errBody := json.Unmarshal([]byte(`{"company":"string","email":"user@example.com","mac":"string","minutes":1440,"name":"John Smith","wlan_id":"6748cfa6-4e12-11e6-9188-0242ac110007"}`), &body)
	if errBody != nil {
...
// TestOrgsGuestsTestUpdateOrgGuestAuthorization1 tests the behavior of the OrgsGuests
func TestOrgsGuestsTestUpdateOrgGuestAuthorization1(t *testing.T) {
	ctx := context.Background()
	orgId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
