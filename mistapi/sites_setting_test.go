...
// TestSitesSettingTestCreateSiteWirelessClientsBlocklist1 tests the behavior of the SitesSetting
func TestSitesSettingTestCreateSiteWirelessClientsBlocklist1(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestSitesSettingTestCreateSiteWatchedStations1 tests the behavior of the SitesSetting
func TestSitesSettingTestCreateSiteWatchedStations1(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
...
// TestSitesSettingTestCreateSiteWirelessClientsAllowlist1 tests the behavior of the SitesSetting
func TestSitesSettingTestCreateSiteWirelessClientsAllowlist1(t *testing.T) {
	ctx := context.Background()
	siteId, errUUID := uuid.Parse("000000ab-00ab-00ab-00ab-0000000000ab")
	if errUUID != nil {
		t.Error(errUUID)
