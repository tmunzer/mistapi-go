...
// TestSitesRFTemplatesTestListSiteRfTemplateDerived tests the behavior of the SitesRFTemplates
func TestSitesRFTemplatesTestListSiteRfTemplateDerived(t *testing.T) {
