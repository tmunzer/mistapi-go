...
// TestSitesRFTemplatesTestGetSiteRfTemplateDerived tests the behavior of the SitesRFTemplates
func TestSitesRFTemplatesTestGetSiteRfTemplateDerived(t *testing.T) {
